    ...
    return (
      <>
        <img
          ...
          src={ImgResult1}
          alt="Emblema Életron Aprendiz"
        />
        <h1 className="titulo-resultado">O Elétron Aprendiz</h1>
        <h2 className="mensagem-resultado">
          {" "}
          Um passo de cada vez, pequeno gafanhoto!{" "}
        </h2>
      </>
    );
  } else if (porcentagemPontuacao >= 25 && porcentagemPontuacao < 50) {
    return (
      <>
        <img
          className="img-resultado"
          src={ImgResult2}
          alt="Emblema Químico Reactivo"
        />
        <h1 className="titulo-resultado">O Químico Reactivo</h1>
        <h2 className="mensagem-resultado">
          {" "}
          Continue a nadar... Continue a nadar... Você está progredindo!{" "}
        </h2>
      </>
    );
  } else if (porcentagemPontuacao >= 50 && porcentagemPontuacao < 75) {
    return (
      <>
        <img
          className="img-resultado"
          src={ImgResult3}
          alt="Emblema Mestre das Reações"
        />
        <h1 className="titulo-resultado">O Mestre das Reações</h1>
        <h2 className="mensagem-resultado">
          {" "}
          Parabéns! Um novo mestre do universo Front-End está a caminho...{" "}
        </h2>
      </>
    );
  } else if (porcentagemPontuacao >= 75 && porcentagemPontuacao < 100) {
    return (
      <>
        <img
          className="img-resultado"
          src={ImgResult4}
          alt="Emblema Átomo Nuclear"
        />
        <h1 className="titulo-resultado">O Átomo Nuclear</h1>
        <h2 className="mensagem-resultado">
          {" "}
          Parabéns! Você conhece mesmo sobre o React.
        </h2>
      </>
    );
